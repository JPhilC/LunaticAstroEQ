...
namespace LunaticAstroEQ.Tests
{
   ...
   public class MountCoordinateTests
   {
      ...
      [DataRow(17, 15, 315.0804882438853, 75, true)]     // Point A (SE)
      [DataRow(5, 60, 315.0804882438853, 330, false)]     // Point B (NW)
      [DataRow(11, 60, 45.080488243885, 30, true)]     // Point C (NE)
      [DataRow(23, 15, 45.080488243885, 285, false)]     // Point D (SW)
      [DataTestMethod]
