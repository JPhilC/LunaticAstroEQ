...
namespace ASCOM.LunaticAstroEQ
{
   ...
   //
   // The Guid attribute sets the CLSID for ASCOM.LunaticAstroEQ.Rate
   // The ClassInterface/None addribute prevents an empty interface called
   // _Rate from being created and used as the [default] interface
   //
   [Guid("f155ffd5-899c-49e2-9a33-5fd54e4964c7")]
   ...
   // this polymorphism. 
   //
   // The Guid attribute sets the CLSID for ASCOM.LunaticAstroEQ.AxisRates
   // The ClassInterface/None addribute prevents an empty interface called
   // _AxisRates from being created and used as the [default] interface
   //
   [Guid("df7679ed-8b24-4757-a2cb-bf8ca95edb71")]
   [ClassInterface(ClassInterfaceType.None)]
   [ComVisible(true)]
   ...
   // this polymorphism. 
   //
   // The Guid attribute sets the CLSID for ASCOM.LunaticAstroEQ.TrackingRates
   // The ClassInterface/None addribute prevents an empty interface called
   ...
   //
   [Guid("104e26de-bc31-4988-bd39-6dfec9c9e9ed")]
   [ClassInterface(ClassInterfaceType.None)]
   [ComVisible(true)]
